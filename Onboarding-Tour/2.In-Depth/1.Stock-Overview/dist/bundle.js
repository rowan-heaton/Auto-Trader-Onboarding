...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_tether_shepherd__ = __webpack_require__(1);
...
let tour = new __WEBPACK_IMPORTED_MODULE_0_tether_shepherd___default.a.Tour({
    defaults: {
  ...
  //step 4
  tour.addStep('step4', {
    title: 'Advertised Stock',
    text: 'Here you can check how many vehicles you have advertised and can view them all.',
    attachTo: '.step-4 top',
    buttons: [{
        text: 'Back',
        action: tour.back,
  ...
  tour.addStep('step8', {
    title: 'Oldest Stock',
    text: 'This lists your oldest stock in your stocklist.',
