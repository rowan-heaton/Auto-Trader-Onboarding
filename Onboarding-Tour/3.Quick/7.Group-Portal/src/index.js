...
text: 'This is the performance dashboard. You can filter the results of the dealer rankings using this section.',
...
buttons: [{
    ...
    text: 'Leads',
    action: function() {
        window.location.href="../../8.Leads/dist/index.htm";
    },
    classes: 'o-link o-link--primary'
}],
showCancelLink: true
